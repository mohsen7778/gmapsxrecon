...
TEMPLATES = {
    ...
    # Template B: Experimental Guessing Variant (Pagination Offset Variant - Returns HTTP 400)
    "template_b": "!1m2!1y{fid1}!2y{fid2}!2m1!2i10!3e1!4m5!5b1!6b1!7b1",
    
    # Template C: Bare Identifier Sequence Without Filter Masks (Returns [null,null,null,null,null,null,1])
    "template_c": "!1m2!1y{fid1}!2y{fid2}!2m1!2i0!3e1!5m2!1s{feature_id}!7e81",

    # Template D: Custom Capture Slot (Dynamically populated from the UI input field)
    "template_d_custom": "{custom_pb}"
}
